...
| `0cebb5b` | 2026-07-28 | Playable in a browser, but ship placement by mouse click was broken (see BUG-002). Use `c1ae6ee` instead.                                                                                                            |
| `c1ae6ee` | 2026-07-28 | Fully playable in a browser: ship placement, battle, shot log, fleet status, difficulty toggle, result screen and Play again. Keyboard and screen-reader support, mobile layout, linting and CI. 69 unit tests pass. |
